...
export function ReportList({ reports, maps, returnTo }: { reports: ReportRow[]; maps: ForumMaps; returnTo: string }) {
  return (
    <section className={styles.panel} aria-label="Signalements">
          ...
          return (
            <article className={styles.reportCard} key={report.id}>
              ...
              <div className={styles.reportActions}>
                <div className={styles.actionTitle}><span>Traitement</span><small>Note visible uniquement par lՎquipe</small></div>
