...
export type TopicRow = { id: string; board_id: string; author_id: string | null; slug: string; title: string; status: string; is_pinned: boolean; is_locked: boolean; post_count: number; last_activity_at: string };
export type PostRow = { id: string; topic_id: string; author_id: string | null; content: string; created_at: string; edited_at: string | null; is_hidden: boolean; hidden_at: string | null; hidden_by: string | null };
